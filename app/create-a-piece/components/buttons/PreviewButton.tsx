...
import { PiecePayload, World, cast_to_piece, cast_to_profile } from "@/types/types"
...
export default function PreviewButton({ values, world, user }: PreviewButtonProps) {
    ...
    return <>
        ...
        <PopupDialog
            ...
            dialogContent=''
            initInputValue={<PieceDisplay piece={cast_to_piece(values)} world={world} author={cast_to_profile(user)} preview={true} />}
            confirmAction={() => { }}
            dialogType='display'
            hideCancel={true}
